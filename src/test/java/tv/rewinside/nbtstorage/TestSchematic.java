...
public class TestSchematic implements NBTFileSchematic {
	...
	public TestSchematic(boolean bln, int n, byte b, String str, long l, short s, String generated) {
		this.bln = bln;
		this.n = n;
		this.b = b;
		this.str = str;
	...
	public String toString() {
		return "TestSchematic{" + "bln=" + bln + ", n=" + n + ", b=" + b + ", str=" + str + ", l=" + l + ", s=" + s + ", generated=" + generated + '}';
	}
